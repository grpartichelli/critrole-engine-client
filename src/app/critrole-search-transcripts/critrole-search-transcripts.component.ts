...
export class CritroleSearchTranscriptsComponent {
  ...
  transcripts: Array<TranscriptModel> | undefined = [
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 02:40:29"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 03:27:51"),
    ...
    },
    {
      ...
      "timestamp": new Date("1970-01-01 01:24:24"),
    ...
    },
    {
      ...
      "timestamp": new Date("1970-01-01 01:34:56"),
    ...
    },
    {
      ...
      "timestamp": new Date("1970-01-01 00:58:49"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 01:54:16"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 02:40:23"),
    ...
    {
      "actor_nickname": "TRAVIS",
      "timestamp": new Date("1970-01-01 02:41:21"),
    ...
    {
      "actor_nickname": "TRAVIS",
      "timestamp": new Date("1970-01-01 02:42:33"),
    ...
    {
      "actor_nickname": "TRAVIS",
      "timestamp": new Date("1970-01-01 02:18:46"),
    ...
    },
    {
      ...
      "timestamp": new Date("1970-01-01 00:56:48"),
    ...
    {
      "actor_nickname": "TRAVIS",
      "timestamp": new Date("1970-01-01 01:08:09"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 02:14:36"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 03:08:22"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 04:37:20"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 04:38:21"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 04:43:39"),
    ...
    {
      "actor_nickname": "MATT",
      "timestamp": new Date("1970-01-01 00:23:50"),
  ...
  searchTranscripts(text : string) {
    this.transcriptService.findByText(text)
      .then(transcripts => {this.transcripts = transcripts; console.log(transcripts)})
      .catch(e => console.log([]))
